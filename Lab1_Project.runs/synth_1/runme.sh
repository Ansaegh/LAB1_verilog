...
HD_PWD='/home/it/Lab1_Project/Lab1_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA4bit_Sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA4bit_Sub.tcl
